...
const FooterBackgroundSvg: React.FC = () => (
  <svg
    width="1260"
    height="457"
            ...
            <div className="lg:col-span-3 xl:col-span-4">
              <div>
                <a href="index.html" className="block mb-6">
                  <img src="assets/images/logo-white.svg" alt="AI Agent Logo" />
                </a>
                <p className="block text-sm text-gray-400 mb-9">
                  Create Smarter, Faster, and Effortless <br /> AI Tools,
                  Products and Startups with AI Agent - AI UI Kit.
                </p>
                <div className="flex">
                  <a
