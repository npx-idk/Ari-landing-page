...
const PLANS: readonly Plan[] = [
	{
		...
		features: ["300 Messages", "50 Image Prompts", "15 Try Ons", "15 Voice Calls", "No Priority Support"],
	...
	},
	{
		...
		features: ["2000 Messages", "500 Image Prompts", "200 Try Ons", "100 Voice Calls", "Basic Support"],
		cta: "Subscribe to Go",
	},
	{
		id: "plus",
		...
		description: "Scale your store confidently with advanced features and reliability.",
		features: ["6000 Messages", "1500 Image Prompts", "550 Try Ons", "250 Voice Calls", "Standard Support"],
	...
	},
	{
		...
		description: "Accelerate your business with power, speed, and priority care.",
		features: ["12000 Messages", "3000 Image Prompts", "1000 Try Ons", "500 Voice Calls", "Priority Support"],
	...
	},
	{
		...
		features: ["20000 Messages", "5000 Image Prompts", "1600 Try Ons", "700 Voice Calls", "Priority Support"],
