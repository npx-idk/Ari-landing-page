...
const CoreFeature: React.FC = () => {
  return (
    <section className="py-28 bg-gray-50 dark:bg-white/[0.01]">
      <div className="wrapper">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
          <div className="core-feature-wrapper bg-white p-9 border border-gray-200 dark:border-white/[0.03] dark:bg-white/[0.05]">
            ...
            <p className="text-gray-500 max-w-[312px] dark:text-gray-400">
              Let our AI-powered service simplify your content creation process.
          ...
          <div className="core-feature-wrapper bg-white p-9 border border-gray-200 dark:border-white/[0.03] dark:bg-white/[0.05]">
            ...
            <p className="text-gray-500 max-w-[312px] dark:text-gray-400">
              Effortlessly access AI-generated content for your blogs, websites,
              and more with our high-quality, convenient service.
            </p>
          </div>
          <div className="core-feature-wrapper bg-white p-9 border border-gray-200 dark:border-white/[0.03] dark:bg-white/[0.05]">
            <div className="core-feature-icon mb-9">
            ...
            <p className="text-gray-500 max-w-[312px] dark:text-gray-400">
              Experience effortless content creation with our AI service. Write
          ...
          <div className="core-feature-wrapper bg-white p-9 border border-gray-200 dark:border-white/[0.03] dark:bg-white/[0.05]">
            ...
            <p className="text-gray-500 max-w-[312px] dark:text-gray-400">
              Get expertly crafted content in no time with our AI service. Where
              quality meets speed.
            </p>
          </div>
          <div className="core-feature-wrapper bg-white p-9 border border-gray-200 dark:border-white/[0.03] dark:bg-white/[0.05]">
